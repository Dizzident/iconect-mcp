...
Major   Potentially breaking API changes
 ...
 @modelcontextprotocol/sdk          ^0.6.0  →   ^1.15.0
 @types/jest                       ^29.5.0  →   ^30.0.0
 @types/node                       ^20.0.0  →  ^24.0.10
 @typescript-eslint/eslint-plugin   ^7.0.0  →   ^8.35.1
 @typescript-eslint/parser          ^7.0.0  →   ^8.35.1
 eslint                            ^8.57.0  →   ^9.30.1
 jest                              ^29.7.0  →   ^30.0.4
